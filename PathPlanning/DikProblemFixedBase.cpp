...
DikProblemFixedBase::DikProblemFixedBase (ForwardKin<double> &fk
...
void DikProblemFixedBase::mapInPtsHtoVecsR ()	{
...
void DikProblemFixedBase::mapInPtsHtoInPtsR ()	{
...
Eigen::Matrix<double, 3, 3> DikProblemFixedBase::buildWrRotReferential
	(int index) {
...
void DikProblemFixedBase::setOutVecsR () {

}

void DikProblemFixedBase::setOutPtsR () {

}

// For print in Mathematica 
//(a) for human
void DikProblemFixedBase::printInPtsH()	{
...
void DikProblemFixedBase::printPtsR()	{
...
//(c). inVecs Robot
void DikProblemFixedBase::printVecsR()	{
